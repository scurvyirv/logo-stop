...
class Circle extends Shape {
    render() {
        ...
        <circle cx="150" cy="150" r="50" fill="${this.color}"/>
...
class Square extends Shape {
    render () {
        return `
        <svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
        <rect x="150" y="150" width="200" height="200" fill="${this.color}"/>
        <text x="175" y="175" font-size="40" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
        </svg>`
    }
};
