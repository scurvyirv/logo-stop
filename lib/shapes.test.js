...
describe('Circle', () => {
    describe('setColor', () => {
        it('should determine the shape fill color', () => {
            ...
            expect(circle.render()).toEqual(`<circle cx="150" cy="150" r="100" fill="yellow"/>`)
        })
    });
    describe('setText', () => {
...
describe('Square', () => {
    describe('setColor', () => {
        it('should determine the shape fill color', () => {
            ...
            expect(square.render()).toEqual(`<rect x="150" y="150" width="100" height="100" fill="yellow"/>`)
        })
    });
    describe('setText', () => {
        it('should determine the three characters (this.text) to be placed within the logo', () => {
...
describe('Triangle', () => {
    describe('setColor', () => {
        it('should determine the shape fill color', () => {
            ...
            expect(triangle.render()).toEqual(`<polygon points="10,200 150,10 290,200" fill="yellow"/>`)
        })
    });
    describe('setText', () => {
        it('should determine the three characters (this.text) to be placed within the logo', () => {
